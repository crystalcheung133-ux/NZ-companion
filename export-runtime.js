...
(function(){
  ...
  window.exportFinalItinerary=function(){
    ...
    const source=(typeof ITINERARY_DATA!=='undefined'?ITINERARY_DATA:{});const days=Object.keys(source).sort((a,b)=>Number(a)-Number(b));if(!days.length)return alert('No itinerary data is available.');
