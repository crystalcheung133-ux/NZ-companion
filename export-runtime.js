...
(function(){
  ...
  window.exportExpenseData=function(){
    if(currentUser()!==((TRIP_CONFIG.admin&&TRIP_CONFIG.admin.user)||'') || typeof window.isAdminMode!=='function' || !window.isAdminMode()) return alert('Enter Admin Mode to export the complete expense data.');
    const arr=readExpenses();
