...
if(!/#mamaModal:not\(\.studio-view\)\.show\s*\{[^}]*position:fixed!important;[^}]*z-index:var\(--engine-traveller-layer,7400\)!important;[^}]*display:grid!important;[^}]*place-items:center!important;[^}]*isolation:isolate!important;/s.test(css)) fail.push('canonical Traveller Selector overlay owner missing');
