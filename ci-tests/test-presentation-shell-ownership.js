...
if(!/body:has\(#mamaModal\.studio-view\.show\) \.app-nav\s*\{[^}]*visibility:hidden!important;[^}]*pointer-events:none!important;/s.test(css)) fail.push('Studio workspace must suppress bottom navigation');
