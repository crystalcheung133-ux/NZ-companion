...
echo "== 1/12 JS syntax gate =="
sh test-syntax.sh || overall=1
echo ""

echo "== 2/12 Release integrity (checksums + manifest) =="
sh test-checksums.sh || overall=1
echo ""

echo "== 3/12 HTML structure =="
sh test-html-structure.sh || overall=1
echo ""

echo "== 4/12 Entity linkage (places/bookings/itinerary/parties) =="
node test-entity-integrity.js || overall=1
echo ""

echo "== 5/12 Guide address integrity =="
python3 address-integrity-test.py || overall=1
echo ""

echo "== 6/12 Timeline integrity =="
node test-timeline-integrity.js || overall=1
echo ""

echo "== 7/12 UX contract =="
node test-ux-contract.js || overall=1
echo ""

echo "== 8/12 RC24.7 focused contract =="
node test-rc24-7.js || overall=1
echo ""

echo "== 9/12 RC24.7.2 regression contract =="
node test-rc24-7-2.js || overall=1
echo ""

echo "== 10/12 RC25.1 contract =="
node test-rc25-1.js || overall=1
echo ""

echo "== 11/12 RC25.1.6 consistency contract =="
node test-rc25-1-6.js || overall=1
echo ""

echo "== 12/12 Runtime production integrity =="
