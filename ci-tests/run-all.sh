...
echo "== 1/15 JS syntax gate =="
sh test-syntax.sh || overall=1
echo ""

echo "== 2/15 Release integrity (checksums + manifest) =="
sh test-checksums.sh || overall=1
echo ""

echo "== 3/15 HTML structure =="
sh test-html-structure.sh || overall=1
echo ""

echo "== 4/15 Entity linkage (places/bookings/itinerary/parties) =="
node test-entity-integrity.js || overall=1
echo ""

echo "== 5/15 Guide address integrity =="
python3 address-integrity-test.py || overall=1
echo ""

echo "== 6/15 Timeline integrity =="
node test-timeline-integrity.js || overall=1
echo ""

echo "== 7/15 UX contract =="
node test-ux-contract.js || overall=1
echo ""

echo "== 8/15 RC24.7 focused contract =="
node test-rc24-7.js || overall=1
echo ""

echo "== 9/15 RC24.7.2 regression contract =="
node test-rc24-7-2.js || overall=1
echo ""

echo "== 10/15 RC25.1 contract =="
node test-rc25-1.js || overall=1
echo ""

echo "== 11/15 RC25.1.6 consistency contract =="
node test-rc25-1-6.js || overall=1
echo ""

echo "== 12/15 RC25.2.2 guide / route contract =="
node test-rc25-2-2.js || overall=1
echo ""

echo "== 13/15 Runtime production integrity =="
node test-runtime-integrity.js || overall=1
echo ""

echo "== 14/15 RC25.2.3 admin modal safe-area contract =="
node test-rc25-2-3.js || overall=1
echo ""

echo "== 15/15 Analytics System v1 contract =="
