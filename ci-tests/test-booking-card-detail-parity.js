...
for(const f of ['booking.phone','booking.officePhone','booking.email','booking.website']){if(!contact.includes(f)){console.error('FAIL contact field not rendered:',f);process.exit(1);}}
