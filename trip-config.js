...
(function(root){
  ...
  const config = Object.freeze({
    ...
    guide: Object.freeze({ excludedPlaceIds: Object.freeze(['airport-queenstown','christchurch-airport','rental-cars-247','lake-tekapo','good-shepherd','firebirds','wolf-coffee','queenstown-central','te-anau','white-water-rafting','freshchoice-queenstown']) }),
