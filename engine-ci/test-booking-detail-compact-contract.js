...
// Engine fixture proves a generic actionable channel exists without assuming a trip-specific provider.
const fixture=B['fixture-hotel-booking'];
assert(fixture&&fixture.bookingUrl,'fixture booking must exercise Book Online channel');

console.log('BOOKING SURFACE ALLOW-LIST: PASS — compact legal surface + usable channels.');
