...
(function(root){
  ...
  const config=Object.freeze({
    ...
    schemaVersion:1,
    tables:Object.freeze({publications:'trip_publications',expenses:'trip_expenses',moments:'trip_moments',generation:'trip_generation',analytics:'trip_analytics_events',documents:'trip_documents',bookings:'trip_bookings'}),
